...
public static final String PREF_DONT_SHOW_SPONSOR_DIALOG = "dont_show_sponsor_dialog";
    ...
    // Key ripple animation
    public static final String PREF_KEY_RIPPLE_ENABLED = "key_ripple_enabled";
    public static final String PREF_KEY_RIPPLE_STYLE = "key_ripple_style";
    public static final String PREF_KEY_RIPPLE_SIZE = "key_ripple_size";
    public static final String PREF_KEY_RIPPLE_SPEED = "key_ripple_speed";
    public static final String PREF_KEY_RIPPLE_OPACITY = "key_ripple_opacity";
    public static final String PREF_KEY_RIPPLE_USE_THEME_COLOR = "key_ripple_use_theme_color";
