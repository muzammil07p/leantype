...
// Key ripple settings
        public final boolean mKeyRippleEnabled;
        public final String mKeyRippleStyle;
        public final float mKeyRippleSize;
        public final float mKeyRippleSpeed;
        public final float mKeyRippleOpacity;
        public final boolean mKeyRippleUseThemeColor;
        ...
        public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
                ...
                mEmojiKeyFit = prefs.getBoolean(Settings.PREF_EMOJI_KEY_FIT, Defaults.PREF_EMOJI_KEY_FIT); // Ripple settings
                mKeyRippleEnabled = prefs.getBoolean(Settings.PREF_KEY_RIPPLE_ENABLED, Defaults.PREF_KEY_RIPPLE_ENABLED);
                mKeyRippleStyle = prefs.getString(Settings.PREF_KEY_RIPPLE_STYLE, Defaults.PREF_KEY_RIPPLE_STYLE);
                mKeyRippleSize = prefs.getFloat(Settings.PREF_KEY_RIPPLE_SIZE, Defaults.PREF_KEY_RIPPLE_SIZE);
                mKeyRippleSpeed = prefs.getFloat(Settings.PREF_KEY_RIPPLE_SPEED, Defaults.PREF_KEY_RIPPLE_SPEED);
                mKeyRippleOpacity = prefs.getFloat(Settings.PREF_KEY_RIPPLE_OPACITY, Defaults.PREF_KEY_RIPPLE_OPACITY);
                mKeyRippleUseThemeColor = prefs.getBoolean(Settings.PREF_KEY_RIPPLE_USE_THEME_COLOR, Defaults.PREF_KEY_RIPPLE_USE_THEME_COLOR);
        }
